...
public class SettingsScreen extends Screen {
	...
	public void init() {
		...
		settingsList.addOptions(ClientSettings.CONFIGS.toArray(new BetterBooleanOption[]{}));
		settingsList.addOptions(ClientSettings.SETTINGS.toArray(new BetterBooleanOption[]{}));
	}
